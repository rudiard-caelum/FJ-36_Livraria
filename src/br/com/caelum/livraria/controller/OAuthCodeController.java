...
public class OAuthCodeController {
	...
	public String redirectToPayfast() throws Exception {
		...
		OAuthClientRequest message = OAuthClientRequest
				...
				.setClientId("livraria_id").setResponseType(OAuth.OAUTH_CODE)
				.setRedirectURI(REDIRECT_URL).buildQueryMessage();
	...
	public String oauthReturn(HttpServletRequest request) throws Exception {
		...
		OAuthClientRequest oauthRequest = OAuthClientRequest
				...
				.setClientId("livraria_id").setClientSecret("livraria_secret")
				.setCode(code).setRedirectURI(REDIRECT_URL).buildQueryMessage();

		OAuthClient client = new OAuthClient(new URLConnectionClient());
		OAuthJSONAccessTokenResponse tokenResponse = client.accessToken(
				oauthRequest, OAuth.HttpMethod.POST);
